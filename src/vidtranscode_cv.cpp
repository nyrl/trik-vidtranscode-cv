...
static const TRIK_VIDTRANSCODE_CV_Params s_trikCvDefaultParams = {
...
static const TRIK_VIDTRANSCODE_CV_DynamicParams s_trikCvDefaultDynamicParams = {
                                   ...
                                   const TRIK_VIDTRANSCODE_CV_DynamicParams* _dynamicParams)
{
  ...
  if (_params == NULL)
    _params = &s_trikCvDefaultParams;
  if (_dynamicParams == NULL)
    _dynamicParams = &s_trikCvDefaultDynamicParams;

  _handle->m_params = *_params;
  _handle->m_dynamicParams = *_dynamicParams;

#warning return IALG_EOK / IALG_EFAIL
  return IALG_EFAIL;
}
